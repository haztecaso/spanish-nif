{
  description = "Pydantic validators for spanish identification codes: NIF, DNI and NIE.";
  inputs = {
  ...
  outputs =
    ...
    let
      ...
      pyprojectOverrides = final: prev: {
        spanish_nif = prev.spanish_nif.overrideAttrs (old: {
    ...
    in {
      packages.x86_64-linux.default =
        pythonSet.mkVirtualEnv "spanish_nif-env" workspace.deps.default;

      apps.x86_64-linux = {
        default = {
          type = "app";
          program = "${self.packages.x86_64-linux.default}/bin/spanish_nif";
        };
      };
      ...
      devShells.x86_64-linux = let
        ...
        uv2nix = let
          ...
          virtualenv = (editablePythonSet.mkVirtualEnv "spanish_nif-dev-env"
